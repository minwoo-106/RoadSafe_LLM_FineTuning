...
OUT_DIR = Path("outputs/eval_stage2_v4_gold_mix")
OUT_JSONL = OUT_DIR / "roadsafe_stage2_v4_gold_mix_eval_v1.jsonl"
OUT_TXT = OUT_DIR / "roadsafe_stage2_v4_gold_mix_eval_v1.txt"
