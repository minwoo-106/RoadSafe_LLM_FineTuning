...
TRAIN_PATH = Path("data/processed/stage2_v2_split/train.jsonl")
VALID_PATH = Path("data/processed/stage2_v2_split/valid.jsonl")

OUT_DIR = Path("outputs/roadsafe_stage2_fault_from_stage1_qlora")
MAX_LENGTH = 896
