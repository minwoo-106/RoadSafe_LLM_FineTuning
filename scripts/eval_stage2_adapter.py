...
ADAPTER_DIR = Path("outputs/roadsafe_stage2_fault_from_stage1_qlora/adapter")
PROMPT_PATH = Path("data/processed/roadsafe_stage2_eval_prompts_v1.jsonl")

OUT_DIR = Path("outputs/eval_stage2")
OUT_JSONL = OUT_DIR / "roadsafe_stage2_eval_v1.jsonl"
OUT_TXT = OUT_DIR / "roadsafe_stage2_eval_v1.txt"
...
"""
    ...
    item = {
        "id": eval_id,
        "prompt": user_prompt,
        "model": "roadsafe_stage2_fault_from_stage1_qlora",
        "answer": answer,
    }
    results.append(item)
