...
OUT_DIR = ROOT / "final_route" / "outputs" / "stage2_accident_structure" / "full_v1"
LOG_DIR = ROOT / "final_route" / "tensorboard" / "stage2_accident_structure_full_v1"
...
def main():
    ...
    print("[INFO] start Stage2 Accident Structure full training")
